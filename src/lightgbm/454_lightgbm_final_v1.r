...
PARAM$finalmodel$num_iterations <- 286
PARAM$finalmodel$learning_rate <- 0.0380343584440596
PARAM$finalmodel$feature_fraction <- 0.699317750222441
PARAM$finalmodel$min_data_in_leaf <- 667
