...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0041", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0041", "DT0041" )
  
  DR_drifting_guantesblancos( "DR0041", "CA0041" )
  FE_historia_guantesblancos( "FE0041", "DR0041" )
  
  #TS_strategy_guantesblancos_202109( "TS0041", "FE0041" )
  
  #HT_tuning_guantesblancos( "HT0041", "TS0041" )
  
  # El ZZ depente de HT y TS
  #ZZ_final_guantesblancos( "ZZ0041", c("HT0041","TS0041") )
...
# por favor notal como este script parte de FE0041

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0041 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0042", "FE0041" )
  
  HT_tuning_guantesblancos( "HT0042", "TS0042" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0042", c("HT0042", "TS0042") )
...
# DT0041, CA0041, DR0041, FE0041, TS0041, HT0041 y ZZ0041
corrida_guantesblancos_202109( "gb41" )


# Luego partiendo de  FE0041
# genero TS0042, HT0042 y ZZ0042

corrida_guantesblancos_202107( "gb42" )
