...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102,
                               202101, 202012, 202011, 202010, 202009, 202008,202007,202005,202004,202003, 202002, 202001, 201912,
                               201911, 201910, 201909)


  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101,
                                  202012, 202011, 202010, 202009, 202008, 202007,202005,202004,202003,202002, 202001, 201912, 201911,
...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    feature_fraction = c( 0.3, 0.75 ),
    num_leaves = c( 10L, 900L,  "integer" ),
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-semv6", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-semv6", "DT0001-semv6" )

  DR_drifting_baseline( "DR0001-semv6", "CA0001-semv6" )
  FE_historia_baseline( "FE0001-semv6", "DR0001-semv6" )

  TS_strategy_baseline_202109( "TS0001-semv6", "FE0001-semv6" )

  HT_tuning_baseline( "HT0001-semv6", "TS0001-semv6" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-semv6", c("HT0001-semv6","TS0001-semv6") )
...
#
 # DT_incorporar_dataset_baseline( "DT0001-semv6", "competencia_2024.csv.gz")
  ...
  #TS_strategy_baseline_202107( "TS0002-semv6", "FE0001-semv6" )

  #HT_tuning_baseline( "HT0002-semv6", "TS0002-semv6" )

  # El ZZ depente de HT y TS
  #ZZ_final_semillerio_baseline( "ZZ0002-semv6", c("HT0002-semv6","TS0002-semv6") )
...
corrida_baseline_semillerio_202109( "boom06" )
