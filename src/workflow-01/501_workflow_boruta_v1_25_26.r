...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0025", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0025", "DT0025" )
  
  DR_drifting_guantesblancos( "DR0025", "CA0025" )
  FE_historia_guantesblancos( "FE0025", "DR0025" )
  
  TS_strategy_guantesblancos_202109( "TS0025", "FE0025" )
  
  HT_tuning_guantesblancos( "HT0025", "TS0025" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0025", c("HT0025","TS0025") )
...
# por favor notal como este script parte de FE0025

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0025 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0026", "FE0025" )
  
  HT_tuning_guantesblancos( "HT0026", "TS0026" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0026", c("HT0026", "TS0026") )
...
# DT0025, CA0025, DR0025, FE0025, TS0025, HT0025 y ZZ0025
corrida_guantesblancos_202109( "gb25" )


# Luego partiendo de  FE0025
# genero TS0026, HT0026 y ZZ0026
