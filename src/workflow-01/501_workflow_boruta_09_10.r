...
FE_historia_boruta <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  #Boruta
  param_local$Boruta$enabled <- FALSE
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  FE_historia_boruta( "FE0009", "DR0009" )
...
# por favor notal como este script parte de FE0009

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0009 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0010", "FE0009" )
...
# DT0009, CA0009, DR0009, FE0009, TS0009, HT0009 y ZZ0009
corrida_guantesblancos_202109( "gb09" )


# Luego partiendo de  FE0009
# genero TS0010, HT0010 y ZZ0010

corrida_guantesblancos_202107( "gb10" )
