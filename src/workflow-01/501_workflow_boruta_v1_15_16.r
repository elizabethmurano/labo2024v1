...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/541_FE_historia_boruta_v2.r"
  ...
  param_local$Boruta$max_runs <- 60
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0015", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0015", "DT0015" )
  
  DR_drifting_guantesblancos( "DR0015", "CA0015" )
  FE_historia_guantesblancos( "FE0015", "DR0015" )
  
  TS_strategy_guantesblancos_202109( "TS0015", "FE0015" )
  
  HT_tuning_guantesblancos( "HT0015", "TS0015" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0015", c("HT0015","TS0015") )
...
# por favor notal como este script parte de FE0015

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0015 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0016", "FE0015" )
...
# DT0015, CA0015, DR0015, FE0015, TS0015, HT0015 y ZZ0015
corrida_guantesblancos_202109( "gb15" )


# Luego partiendo de  FE0015
# genero TS0016, HT0016 y ZZ0016

corrida_guantesblancos_202107( "gb16" )
