...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0021", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0021", "DT0021" )
  
  DR_drifting_guantesblancos( "DR0021", "CA0021" )
  FE_historia_guantesblancos( "FE0021", "DR0021" )
  
  TS_strategy_guantesblancos_202109( "TS0021", "FE0021" )
  
  HT_tuning_guantesblancos( "HT0021", "TS0021" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0021", c("HT0021","TS0021") )
...
# por favor notal como este script parte de FE0021

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0021 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0022", "FE0021" )
  
  HT_tuning_guantesblancos( "HT0022", "TS0022" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0022", c("HT0022", "TS0022") )
...
# DT0021, CA0021, DR0021, FE0021, TS0021, HT0021 y ZZ0021
corrida_guantesblancos_202109( "gb21" )


# Luego partiendo de  FE0021
# genero TS0022, HT0022 y ZZ0022

corrida_guantesblancos_202107( "gb22" )
