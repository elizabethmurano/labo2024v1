...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c( 600L, 1000L,  "integer" ),
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-semv2", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-semv2", "DT0001-semv2" )

  DR_drifting_baseline( "DR0001-semv2", "CA0001-semv2" )
  FE_historia_baseline( "FE0001-semv2", "DR0001-semv2" )

  TS_strategy_baseline_202109( "TS0001-semv2", "FE0001-semv2" )

  HT_tuning_baseline( "HT0001-semv2", "TS0001-semv2" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-semv2", c("HT0001-semv2","TS0001-semv2") )
...
#
 # DT_incorporar_dataset_baseline( "DT0001-semv2", "competencia_2024.csv.gz")
  ...
  #TS_strategy_baseline_202107( "TS0002-semv2", "FE0001-semv2" )

  #HT_tuning_baseline( "HT0002-semv2", "TS0002-semv2" )

  # El ZZ depente de HT y TS
  #ZZ_final_semillerio_baseline( "ZZ0002-semv2", c("HT0002-semv2","TS0002-semv2") )
...
corrida_baseline_semillerio_202109( "boom01" )
