...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/541_FE_historia_boruta_v3.r"
...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202107, 202106, 202105,202104,202103,202102,202101,202012,202011,201910,201909,201908,201907)
  
  
  param_local$train$training <- c(202105, 202104, 202103,202102,202101,202012,202011,201910,201909,201908,201907,201906,201905)
...
TS_strategy_guantesblancos_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202105, 202104,202103,202102,202101,202012,202011,201910,201909,201908,201907)
  
  
  param_local$train$training <- c(202103,202102,202101,202012,202011,201910,201909,201908,201907,201906,201905)
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0029", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0029", "DT0029" )
  
  DR_drifting_guantesblancos( "DR0029", "CA0029" )
  FE_historia_guantesblancos( "FE0029", "DR0029" )
  
  TS_strategy_guantesblancos_202109( "TS0029", "FE0029" )
  
  HT_tuning_guantesblancos( "HT0029", "TS0029" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0029", c("HT0029","TS0029") )
...
# por favor notal como este script parte de FE0029

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0029 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0030", "FE0029" )
  
  HT_tuning_guantesblancos( "HT0030", "TS0030" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0030", c("HT0030", "TS0030") )
...
# DT0029, CA0029, DR0029, FE0029, TS0029, HT0029 y ZZ0029
corrida_guantesblancos_202109( "gb29" )


# Luego partiendo de  FE0029
# genero TS0030, HT0030 y ZZ0030
