...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0023", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0023", "DT0023" )
  
  DR_drifting_guantesblancos( "DR0023", "CA0023" )
  FE_historia_guantesblancos( "FE0023", "DR0023" )
  
  TS_strategy_guantesblancos_202109( "TS0023", "FE0023" )
  
  HT_tuning_guantesblancos( "HT0023", "TS0023" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0023", c("HT0023","TS0023") )
...
# por favor notal como este script parte de FE0023

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0023 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0024", "FE0023" )
  
  HT_tuning_guantesblancos( "HT0024", "TS0024" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0024", c("HT0024", "TS0024") )
...
# DT0023, CA0023, DR0023, FE0023, TS0023, HT0023 y ZZ0023
corrida_guantesblancos_202109( "gb23" )


# Luego partiendo de  FE0023
# genero TS0024, HT0024 y ZZ0024
