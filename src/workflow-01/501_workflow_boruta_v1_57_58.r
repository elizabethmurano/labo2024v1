...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0057", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0057", "DT0057" )
  
  DR_drifting_guantesblancos( "DR0057", "CA0057" )
  FE_historia_guantesblancos( "FE0057", "DR0057" )
  
  TS_strategy_guantesblancos_202109( "TS0057", "FE0057" )
  
  HT_tuning_guantesblancos( "HT0057", "TS0057" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0057", c("HT0057","TS0057") )
...
# por favor notal como este script parte de FE0057

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0057 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0058", "FE0057" )
  
  HT_tuning_guantesblancos( "HT0058", "TS0058" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0058", c("HT0058", "TS0058") )
...
# DT0057, CA0057, DR0057, FE0057, TS0057, HT0057 y ZZ0057
corrida_guantesblancos_202109( "gb57" )


# Luego partiendo de  FE0057
# genero TS0058, HT0058 y ZZ0058

corrida_guantesblancos_202107( "gb58" )
