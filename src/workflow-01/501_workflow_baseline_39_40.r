...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0039", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0039", "DT0039" )
  
  DR_drifting_guantesblancos( "DR0039", "CA0039" )
  FE_historia_guantesblancos( "FE0039", "DR0039" )
  
  #TS_strategy_guantesblancos_202109( "TS0039", "FE0039" )
  
  #HT_tuning_guantesblancos( "HT0039", "TS0039" )
  
  # El ZZ depente de HT y TS
  #ZZ_final_guantesblancos( "ZZ0039", c("HT0039","TS0039") )
...
# por favor notal como este script parte de FE0039

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0039 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0040", "FE0039" )
  
  HT_tuning_guantesblancos( "HT0040", "TS0040" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0040", c("HT0040", "TS0040") )
...
# DT0039, CA0039, DR0039, FE0039, TS0039, HT0039 y ZZ0039
corrida_guantesblancos_202109( "gb39" )


# Luego partiendo de  FE0039
# genero TS0040, HT0040 y ZZ0040

corrida_guantesblancos_202107( "gb40" )
