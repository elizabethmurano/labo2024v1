...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$Boruta$max_runs <- 50
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0027", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0027", "DT0027" )
  
  DR_drifting_guantesblancos( "DR0027", "CA0027" )
  FE_historia_guantesblancos( "FE0027", "DR0027" )
  
  TS_strategy_guantesblancos_202109( "TS0027", "FE0027" )
  
  HT_tuning_guantesblancos( "HT0027", "TS0027" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0027", c("HT0027","TS0027") )
...
# por favor notal como este script parte de FE0027

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0027 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0028", "FE0027" )
  
  HT_tuning_guantesblancos( "HT0028", "TS0028" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0028", c("HT0028", "TS0028") )
...
# DT0027, CA0027, DR0027, FE0027, TS0027, HT0027 y ZZ0027
corrida_guantesblancos_202109( "gb27" )


# Luego partiendo de  FE0027
# genero TS0028, HT0028 y ZZ0028
