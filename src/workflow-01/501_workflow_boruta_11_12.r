...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  FE_historia_boruta( "FE0011", "DR0011" )

  TS_strategy_guantesblancos_202109( "TS0011", "FE0011" )
...
# por favor notal como este script parte de FE0011

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0011 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0012", "FE0011" )
...
# DT0011, CA0011, DR0011, FE0011, TS0011, HT0011 y ZZ0011
corrida_guantesblancos_202109( "gb11" )


# Luego partiendo de  FE0011
# genero TS0012, HT0012 y ZZ0012

corrida_guantesblancos_202107( "gb12" )
