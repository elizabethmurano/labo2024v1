...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0017", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0017", "DT0017" )
  
  DR_drifting_guantesblancos( "DR0017", "CA0017" )
  FE_historia_guantesblancos( "FE0017", "DR0017" )
  
  TS_strategy_guantesblancos_202109( "TS0017", "FE0017" )
  
  HT_tuning_guantesblancos( "HT0017", "TS0017" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0017", c("HT0017","TS0017") )
...
# por favor notal como este script parte de FE0017

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0017 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0018", "FE0017" )
  
  HT_tuning_guantesblancos( "HT0018", "TS0018" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0018", c("HT0018", "TS0018") )
...
# DT0017, CA0017, DR0017, FE0017, TS0017, HT0017 y ZZ0017
corrida_guantesblancos_202109( "gb17" )


# Luego partiendo de  FE0017
# genero TS0018, HT0018 y ZZ0018
