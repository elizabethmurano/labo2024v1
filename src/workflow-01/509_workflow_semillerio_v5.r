...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c( 1000L, 2000L,  "integer" ),
    min_data_in_leaf = c( 700L, 1200L, "integer" )
  )
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-semv5", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-semv5", "DT0001-semv5" )

  DR_drifting_baseline( "DR0001-semv5", "CA0001-semv5" )
  FE_historia_baseline( "FE0001-semv5", "DR0001-semv5" )

  TS_strategy_baseline_202109( "TS0001-semv5", "FE0001-semv5" )

  HT_tuning_baseline( "HT0001-semv5", "TS0001-semv5" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-semv5", c("HT0001-semv5","TS0001-semv5") )
...
#
 # DT_incorporar_dataset_baseline( "DT0001-semv5", "competencia_2024.csv.gz")
  ...
  #TS_strategy_baseline_202107( "TS0002-semv5", "FE0001-semv5" )

  #HT_tuning_baseline( "HT0002-semv5", "TS0002-semv5" )

  # El ZZ depente de HT y TS
  #ZZ_final_semillerio_baseline( "ZZ0002-semv5", c("HT0002-semv5","TS0002-semv5") )
...
corrida_baseline_semillerio_202109( "boom05" )
