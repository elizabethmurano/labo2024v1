...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$CanaritosAsesinos$ratio <- 1.4
  # desvios estandar de la media, para el cutoff
  param_local$CanaritosAsesinos$desvios <- 1.4
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0055", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0055", "DT0055" )
  
  DR_drifting_guantesblancos( "DR0055", "CA0055" )
  FE_historia_guantesblancos( "FE0055", "DR0055" )
  
  #TS_strategy_guantesblancos_202109( "TS0055", "FE0055" )
  
  #HT_tuning_guantesblancos( "HT0055", "TS0055" )
  
  # El ZZ depente de HT y TS
  #ZZ_final_guantesblancos( "ZZ0055", c("HT0055","TS0055") )
...
# por favor notal como este script parte de FE0055

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0055 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0056", "FE0055" )
  
  HT_tuning_guantesblancos( "HT0056", "TS0056" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0056", c("HT0056", "TS0056") )
...
# DT0055, CA0055, DR0055, FE0055, TS0055, HT0055 y ZZ0055
corrida_guantesblancos_202109( "gb55" )


# Luego partiendo de  FE0055
# genero TS0056, HT0056 y ZZ0056

corrida_guantesblancos_202107( "gb56" )
