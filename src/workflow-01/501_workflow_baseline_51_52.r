...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0051", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0051", "DT0051" )
  
  DR_drifting_guantesblancos( "DR0051", "CA0051" )
  FE_historia_guantesblancos( "FE0051", "DR0051" )
  
  #TS_strategy_guantesblancos_202109( "TS0051", "FE0051" )
  
  #HT_tuning_guantesblancos( "HT0051", "TS0051" )
  
  # El ZZ depente de HT y TS
  #ZZ_final_guantesblancos( "ZZ0051", c("HT0051","TS0051") )
...
# por favor notal como este script parte de FE0051

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0051 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0052", "FE0051" )
  
  HT_tuning_guantesblancos( "HT0052", "TS0052" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0052", c("HT0052", "TS0052") )
...
# DT0051, CA0051, DR0051, FE0051, TS0051, HT0051 y ZZ0051
corrida_guantesblancos_202109( "gb51" )


# Luego partiendo de  FE0051
# genero TS0052, HT0052 y ZZ0052

corrida_guantesblancos_202107( "gb52" )
