...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0045", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0045", "DT0045" )
  
  DR_drifting_guantesblancos( "DR0045", "CA0045" )
  FE_historia_guantesblancos( "FE0045", "DR0045" )
  
  #TS_strategy_guantesblancos_202109( "TS0045", "FE0045" )
  
  #HT_tuning_guantesblancos( "HT0045", "TS0045" )
  
  # El ZZ depente de HT y TS
  #ZZ_final_guantesblancos( "ZZ0045", c("HT0045","TS0045") )
...
# por favor notal como este script parte de FE0045

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0045 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0046", "FE0045" )
  
  HT_tuning_guantesblancos( "HT0046", "TS0046" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0046", c("HT0046", "TS0046") )
...
# DT0045, CA0045, DR0045, FE0045, TS0045, HT0045 y ZZ0045
corrida_guantesblancos_202109( "gb45" )


# Luego partiendo de  FE0045
# genero TS0046, HT0046 y ZZ0046

corrida_guantesblancos_202107( "gb46" )
