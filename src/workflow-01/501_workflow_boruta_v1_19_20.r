...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0019", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0019", "DT0019" )
  
  DR_drifting_guantesblancos( "DR0019", "CA0019" )
  FE_historia_guantesblancos( "FE0019", "DR0019" )
  
  TS_strategy_guantesblancos_202109( "TS0019", "FE0019" )
  
  HT_tuning_guantesblancos( "HT0019", "TS0019" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0019", c("HT0019","TS0019") )
...
# por favor notal como este script parte de FE0019

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0019 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0020", "FE0019" )
  
  HT_tuning_guantesblancos( "HT0020", "TS0020" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0020", c("HT0020", "TS0020") )
...
# DT0019, CA0019, DR0019, FE0019, TS0019, HT0019 y ZZ0019
corrida_guantesblancos_202109( "gb19" )


# Luego partiendo de  FE0019
# genero TS0020, HT0020 y ZZ0020
