...
FE_historia_boruta_v1 <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0013", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0013", "DT0013" )

  DR_drifting_guantesblancos( "DR0013", "CA0013" )
  FE_historia_guantesblancos( "FE0013", "DR0013" )

  TS_strategy_guantesblancos_202109( "TS0013", "FE0013" )

  HT_tuning_guantesblancos( "HT0013", "TS0013" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0013", c("HT0013","TS0013") )
...
# por favor notal como este script parte de FE0013

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0013 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0014", "FE0013" )

  HT_tuning_guantesblancos( "HT0014", "TS0014" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0014", c("HT0014", "TS0014") )
...
# DT0013, CA0013, DR0013, FE0013, TS0013, HT0013 y ZZ0013
corrida_guantesblancos_202109( "gb13" )


# Luego partiendo de  FE0013
# genero TS0014, HT0014 y ZZ0014

corrida_guantesblancos_202107( "gb14" )
