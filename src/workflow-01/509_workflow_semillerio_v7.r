...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c( 50L, 2000L,  "integer" ),
    min_data_in_leaf = c( 100L, 3000L, "integer" )
  )
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-semv7", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-semv7", "DT0001-semv7" )

  DR_drifting_baseline( "DR0001-semv7", "CA0001-semv7" )
  FE_historia_baseline( "FE0001-semv7", "DR0001-semv7" )

  TS_strategy_baseline_202109( "TS0001-semv7", "FE0001-semv7" )

  HT_tuning_baseline( "HT0001-semv7", "TS0001-semv7" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-semv7", c("HT0001-semv7","TS0001-semv7") )
...
#
 # DT_incorporar_dataset_baseline( "DT0001-semv7", "competencia_2024.csv.gz")
  ...
  #TS_strategy_baseline_202107( "TS0002-semv7", "FE0001-semv7" )

  #HT_tuning_baseline( "HT0002-semv7", "TS0002-semv7" )

  # El ZZ depente de HT y TS
  #ZZ_final_semillerio_baseline( "ZZ0002-semv7", c("HT0002-semv7","TS0002-semv7") )
...
corrida_baseline_semillerio_202109( "boom07" )
