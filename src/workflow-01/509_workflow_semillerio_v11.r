...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c( 100L, 500L,  "integer" ),
    min_data_in_leaf = c( 3000L, 5000L, "integer" )
  )
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  HT_tuning_baseline( "HT0001-semv11", "TS0001-semv8" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-semv11", c("HT0001-semv11","TS0001-semv8") )
...
corrida_baseline_semillerio_202109( "Exp_Final_3" )
