...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0037", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0037", "DT0037" )
  
  DR_drifting_guantesblancos( "DR0037", "CA0037" )
  FE_historia_guantesblancos( "FE0037", "DR0037" )
  
  #TS_strategy_guantesblancos_202109( "TS0037", "FE0037" )
  
  #HT_tuning_guantesblancos( "HT0037", "TS0037" )
  
  # El ZZ depente de HT y TS
  #ZZ_final_guantesblancos( "ZZ0037", c("HT0037","TS0037") )
...
# por favor notal como este script parte de FE0037

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0037 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0038", "FE0037" )
  
  HT_tuning_guantesblancos( "HT0038", "TS0038" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0038", c("HT0038", "TS0038") )
...
# DT0037, CA0037, DR0037, FE0037, TS0037, HT0037 y ZZ0037
corrida_guantesblancos_202109( "gb37" )


# Luego partiendo de  FE0037
# genero TS0038, HT0038 y ZZ0038

corrida_guantesblancos_202107( "gb38" )
