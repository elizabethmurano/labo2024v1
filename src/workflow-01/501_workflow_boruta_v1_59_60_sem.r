...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c( 600L, 1500L,  "integer" ),
...
ZZ_final_semillerio_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/z881_ZZ_final_semillerio.rr"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0059", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0059", "DT0059" )
  
  DR_drifting_guantesblancos( "DR0059", "CA0059" )
  FE_historia_guantesblancos( "FE0059", "DR0059" )
  
  TS_strategy_guantesblancos_202109( "TS0059", "FE0059" )
  
  HT_tuning_guantesblancos( "HT0059", "TS0059" )
  
  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0059_sem", c("HT0059","TS0059") )
...
# por favor notal como este script parte de FE0059

#corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
#{
#  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0059 y parto de alli
#  TS_strategy_guantesblancos_202107( "TS0060", "FE0059" )
  
#  HT_tuning_guantesblancos( "HT0060", "TS0060" )
  
  # El ZZ depente de HT y TS
#  ZZ_final_guantesblancos( "ZZ0060", c("HT0060", "TS0060") )
...
# DT0059, CA0059, DR0059, FE0059, TS0059, HT0059 y ZZ0059
corrida_guantesblancos_202109( "gb59" )


# Luego partiendo de  FE0059
# genero TS0060, HT0060 y ZZ0060

#corrida_guantesblancos_202107( "gb60" )
