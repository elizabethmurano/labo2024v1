...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0053", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0053", "DT0053" )
  
  DR_drifting_guantesblancos( "DR0053", "CA0053" )
  FE_historia_guantesblancos( "FE0053", "DR0053" )
  
  #TS_strategy_guantesblancos_202109( "TS0053", "FE0053" )
  
  #HT_tuning_guantesblancos( "HT0053", "TS0053" )
  
  # El ZZ depente de HT y TS
  #ZZ_final_guantesblancos( "ZZ0053", c("HT0053","TS0053") )
...
# por favor notal como este script parte de FE0053

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0053 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0054", "FE0053" )
  
  HT_tuning_guantesblancos( "HT0054", "TS0054" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0054", c("HT0054", "TS0054") )
...
# DT0053, CA0053, DR0053, FE0053, TS0053, HT0053 y ZZ0053
corrida_guantesblancos_202109( "gb53" )


# Luego partiendo de  FE0053
# genero TS0054, HT0054 y ZZ0054

corrida_guantesblancos_202107( "gb54" )
